...
class IndexFrame:
    def __init__(self, top=None):
        ...
        top.configure(background="#c7f7f7")
        self.top = top

        self.Label1 = tk.Label(self.top)
        self.Label1.place(relx=0.161, rely=0.828, height=101, width=644)
        self.Label1.configure(background="#c7f7f7")
  ...
  Jim Gabriel Ariñez Bautista                 Camila Belen Quispe Flores''')
        ...
        self.logoJhoelito.configure(background="#c7f7f7")
        ...
        self.logoSistemas.configure(background="#c7f7f7")
        ...
        self.lblTresRaya.place(relx=0.1, rely=0.271, height=51, width=365)
        self.lblTresRaya.configure(background="#c7f7f7")
        ...
        self.lblMision.place(relx=0.303, rely=0.51, height=61, width=205)
        self.lblMision.configure(background="#c7f7f7")
        ...
        self.lblTitle.configure(background="#c7f7f7")
        ...
        self.lblSubtitle.configure(background="#c7f7f7")
        ...
        self.lblChika.place(relx=0.626, rely=0.271, height=281, width=266)
        self.lblChika.configure(background="#c7f7f7")
        ...
        self.btnG2.place(relx=0.405, rely=0.605, height=56, width=157)
        ...
        self.btnG1.place(relx=0.202, rely=0.382, height=56, width=157)
